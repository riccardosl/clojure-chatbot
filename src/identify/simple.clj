...
(defn -main[& args]
  ...
  (defn guess_image [image-path]
      (def nippy (util/read-nippy-file "trained/trained-network.nippy"))
      (println (guess-with-mappings nippy image-path "trained/fruits-mapping.edn"))
  )
